...
import { MousePointer2, Settings, Plus, Activity } from 'lucide-react';
...
const TelemetryTypewriter = () => {
    ...
    useEffect(() => {
        let currentText = "";
        let charIdx = 0;
        const targetMsg = telemetryMessages[msgIdx];
...
const visibilityColumns = ['Layer', 'Primary Job', 'How It Helps A Business'];
const visibilityRows = [
    [
        'SEO',
        'Help a site rank and stay crawlable in search engines.',
        'Supports discoverability through technical structure, page relevance, and strong site performance.'
    ],
    [
        'AEO',
        'Help answer engines pull direct responses from the site.',
        'Supports featured answers through concise definitions, question-based headings, and direct on-page explanations.'
    ],
    [
        'GEO',
        'Help AI systems understand, extract, and cite the business accurately.',
        'Supports citation and summarization through entity clarity, comparison content, plain-language outcomes, and scannable sections.'
    ]
];
...
const visibilityQuestions = [
    {
        ...
        answer: 'A business site should not only rank. It should also explain the company clearly enough that AI answer engines can summarize the services without guessing.'
    },
    {
        question: 'What does The Provider\'s System build around this?',
        answer: 'The work combines website development, AI and automation services, SEO foundations, AEO structure, and GEO layers so the business is easier to find and easier to understand.'
    }
];
    ...
    return (
        <section id="features" ref={sectionRef} className="py-24 px-6 md:px-16 bg-background relative z-20">
            <div className="max-w-6xl mx-auto">
                ...
                <div className="mt-16 grid grid-cols-1 xl:grid-cols-[1.25fr_0.75fr] gap-8 items-start">
                    <GeoComparisonTable
                        eyebrow="Visibility Structure"
                        title="What is the difference between SEO, AEO, and GEO?"
                        intro="These layers solve different discovery problems. Strong sites usually need all three working together."
                        columns={visibilityColumns}
                        rows={visibilityRows}
                        note="What this means: a well-built site should rank in search, answer direct questions clearly, and give AI systems enough structure to cite the business accurately."
                    />
                    <GeoQuestionGrid
                        eyebrow="Plain Language"
                        title="What this means for an owner"
                        items={visibilityQuestions}
                    />
                </div>
            </div>
        </section>
