        ...
        <section ref={containerRef} className="relative h-[100dvh] w-full flex items-end pb-24 px-6 md:px-16 overflow-hidden">
            ...
            <div className="relative z-10 max-w-4xl text-white">
                ...
                <p className="hero-anim font-heading text-lg md:text-xl max-w-2xl text-white/80 mb-10 font-light leading-relaxed">
                    The Provider System builds AI-powered automation, custom SaaS applications, and internal workflow tools for founders and operators. We replace manual bottlenecks with scalable, deployed systems — so you reclaim your time without sacrificing operational control.
                </p>
