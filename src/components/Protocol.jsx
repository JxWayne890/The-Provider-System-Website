...
const processQuestions = [
    {
        question: 'What happens during Audit & Map?',
        answer: 'The Provider\'s System reviews the current website, tools, handoffs, and manual bottlenecks so the project solves the right operational or visibility problem first.'
    },
    {
        question: 'What happens during Build & Route?',
        answer: 'The team builds the website, automation, or internal workflow logic, then connects the right tools so leads, data, and actions move through a defined system.'
    },
    {
        question: 'What happens during Protect & Run?',
        answer: 'The finished system is launched, documented, and monitored so the client has a reliable setup that is easier to maintain, easier to scale, and easier to understand.'
    }
];
        ...
        <section id="protocol" ref={containerRef} className="py-24 px-6 md:px-16 bg-primary flex flex-col items-center">
            <div className="max-w-7xl mx-auto w-full">
                ...
                <GeoQuestionGrid
                    ...
                    title="What the process produces in plain language"
                    intro="Each phase has a clear job: identify the right fix, build the right system, and leave the client with something stable and usable."
                    items={processQuestions}
                />
            </div>
        </section>
    );
