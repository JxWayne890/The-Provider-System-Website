...
export function buildLocalBusinessSchema() {
    return {
        ...
        "description": "The Provider System builds high-performance AI automation, SaaS applications, and internal workflow tools that help founders and operators reclaim their time without sacrificing operational control.",
        "priceRange": "$$",
        "knowsAbout": [
            "AI automation",
            "workflow automation",
