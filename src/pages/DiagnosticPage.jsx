    ...
    return (
        <div className="min-h-screen pt-24 pb-12 bg-[#05162D] text-white flex flex-col justify-center relative overflow-hidden">
            <SEO
                ...
                description="Take The Provider System 2-minute operational audit to identify your exact bottlenecks, calculate financial leakage from manual processes, and generate a custom automation blueprint."
                url="/diagnostic"
                schemas={[
                    {
                        "@type": "WebPage",
